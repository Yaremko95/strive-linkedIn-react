...
class InteractionCard extends Component {
    ...
    render() {
        ...
        <ContainerCard background='white' padding='0'>
           ...
           <Row style={{display:'flex',alignItems:'center',backgroundColor:'#f3f6f8'}}>
             <p style={{color:'#0073bc',fontWeight:'bold', margin:'0',padding:'10px',paddingLeft:'18px'}}>Write an article
           <span style={{color:'#666666',fontWeight:'lighter'}} > on LinkedIn</span></p></Row>
